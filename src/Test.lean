...
#guard runRuntime "0 0=" == .ok { stack := [-1], output := "" }
#guard runRuntime "1 0=" == .ok { stack := [0], output := "" }
#guard runRuntime "-1 0=" == .ok { stack := [0], output := "" }
#guard runRuntime "0=" == .error (.stackUnderflow "0=" 1)
#guard runRuntime "0 0<" == .ok { stack := [0], output := "" }
#guard runRuntime "-1 0<" == .ok { stack := [-1], output := "" }
#guard runRuntime "1 0<" == .ok { stack := [0], output := "" }
#guard runRuntime "0<" == .error (.stackUnderflow "0<" 1)
#guard runRuntime "0 ?DUP" == .ok { stack := [0], output := "" }
#guard runRuntime "1 ?DUP" == .ok { stack := [1, 1], output := "" }
#guard runRuntime "-1 ?DUP" == .ok { stack := [-1, -1], output := "" }
#guard runRuntime "?DUP" == .error (.stackUnderflow "?DUP" 1)
